            ...
            <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-dark p-0">
                <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#">
                    ...
                    <ul class="navbar-nav text-light" id="accordionSidebar">
                        ...
                        <li class="nav-item"><a class="nav-link" href="{{env('URL_BASE')}}perfil"><i class="fas fa-user"></i><span>Perfil</span></a></li>
                        <li class="nav-item"><a class="nav-link" href="{{env('URL_BASE')}}meusblogs"><i class="fas fa-blog"></i><span>Meus Blogs</span></a></li>
                        <li class="nav-item"><a class="nav-link" href="{{env('URL_BASE')}}logout"><i class="fas fa-sign-out-alt"></i><span>Deslogar</span></a></li>
                    </ul>
